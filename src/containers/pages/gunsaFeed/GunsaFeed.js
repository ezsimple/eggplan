...
import sample_chart from 'images/sample_chart.png';
import styles from './GunsaFeed.module.scss';
...
class GunsaFeed extends Component {
  constructor(props) {
    super(props);
    this.state = {
      date: null,
    ...
    return (
      <Fragment>
        ...
        <div className="pig-container">
          ...
          <div className="chart mT30 mB30 txt-center">
            <img src={sample_chart} alt={'chart'} style={{ width: '150px' }} />
          </div>
          <div className="board-list-s mT20">
            <table>
              ...
              <thead>
                <tr>
                  <th><Trans>m.임신돈</Trans>(8)</th>
                  <th><Trans>m.입장횟수</Trans></th>
                  <th><Trans>m.섭취량</Trans>(kg)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
