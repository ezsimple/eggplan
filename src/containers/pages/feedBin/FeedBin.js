...
import styles from './FeedBin.module.scss';
import { Trans } from 'react-i18next';

class FeedBin extends Component {
  constructor(props) {
    super(props);
    this.state = {
      date: null,
        ...
        <div className="pig-container">
          <div className="pig-search">
            ...
            <SingleDatePicker
              ...
              showClearDate
              readOnly
              id={'datepicker0'} // PropTypes.string.isRequired,
            />
          ...
          <div className="board-list mT20">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <th colSpan="2"><Trans>m.농장합계</Trans></th>
                  <td>
                    <div className="sbar-result">
